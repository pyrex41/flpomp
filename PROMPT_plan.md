...
998. **Study before assuming**: Search codebase thoroughly before making claims
...
- Use up to 50 parallel Sonnet subagents for codebase analysis
...
If the task list is empty and no specs exist yet:
- `echo "no specs found - add specs to specs/ directory" > .stop`
